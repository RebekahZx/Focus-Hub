...
import { signIn } from "next-auth/react";
 ...
 const page=()=>{
    ...
    return (
        <div className="flex min-h-screen bg-gradient-to-r from-yellow-100 to-pink-200 dark:from-gray-900 dark:to-gray-800">
            {isLoading && <Loader/>}
            ...
            <div className="flex flex-col justify-center w-full p-8 lg:w-1/2">
                <div className="max-w-md mx-auto">
                        <h1 className="mb-4 text-4xl text-gray-800 font-bold">Welcome to FocusHub</h1>
                        <p className="mb-8 text-gray-600 dark:text-gray-100">Connect with your team anytime anywhere</p>
                        <div className="space-y-4">
                            <Button className="text-gray-800 w-full dark:hover:bg-white dark:hover:text-black" variant="outline"
