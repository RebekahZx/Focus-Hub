...
// import { Video } from "lucide-react";  // ✅ Correct
import  {Button} from "@/components/ui/button";  // ✅ Correct

// import { Moon, Sun } from "lucide-react";  // ✅ Correct
...
//                     <span className="hidden md:block text-xl font-semibold text-gray-800 dark:text-gray-200">FocusHub
...
//                 </div>
//                 <div className="flex items-center space-x-4">
//                     <span className="text-md text-gray-500 dark:text-gray-300">Hi, <span className="text-yellow-600 dark:text-blue-500 animate-pulse drop-shadow-lg">{session?.user?.name}</span> &nbsp;
//                         {formatTimeDate()}
...
//                                     <Avatar src={session?.user?.image} className="w-8 h-8 rounded-full"/>
//                                 </DropdownMenuTrigger>
//                                 <DropdownMenuContent>
...
const Header = () => {
  ...
  return (
    <div className='flex items-center justify-between p-6 bg-white dark:bg-gray-900 border-b dark:border-gray-700 '>
        ...
        <div className='flex items-center space-x-4'>
            <span className='text-md text-gray-500 dark:text-gray-200'>Hi, <span className="text-yellow-600 dark:text-blue-500 animate-pulse drop-shadow-lg">{session?.user?.name}</span> &nbsp;
                 {formatTimeDate()}
            </span>
            <Button variant="ghost" size='icon' onClick={() => setTheme(theme === 'dark'? "light" : "dark")}>
                {theme === 'dark ' ?(
